...
public class MyService {
    ...
    public void signalAll_A() {
        try {
            lock.lock();
            System.out.println("singalAll_A 时间为 " + System.currentTimeMillis() + " ThreadName=" + Thread.currentThread().getName());
    ...
    public void signalAll_B() {
        try {
            lock.lock();
            System.out.println("singalAll_B 时间为 " + System.currentTimeMillis() + " ThreadName=" + Thread.currentThread().getName());
